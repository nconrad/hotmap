...
export default class Hotmap {
    ...
    hideHoverEffects() {
        ...
        this.ele.querySelectorAll('.hover-box').forEach(el => el.remove());
        this.ele.querySelectorAll('.drag-icon').forEach(el => el.remove());
    ...
    yAxisHover() {
        ...
        axisBox.onmousemove = evt => {
            ...
            dragBox.innerHTML =
                `<div style="float: left">` + icon.innerHTML + `</div>` +
