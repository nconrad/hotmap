...
export default class Hotmap {
    constructor(params) {
        ...
        // category labels
        this.yMetaLabels = params.colMetaLabels || [];
        this.xMetaLabels = params.rowMetaLabels || [];
    ...
    */
    ...
    onScroll(xStart, yStart) {
        // console.log('scroll', xStart, yStart)
